...
var scaleX = d3.scalePoint().domain(["","Biomass", "Geothermal", "Solar Thermal", "Hydro", "Wind", "Biofuels"]).range([0, 600]);
...
var scaleY = d3.scaleLinear().domain([700000,0]).range([0, 400]);  //remember that 0,0 is at the top of the screen! 300 is the lowest value on the y axis
...
d3.csv('./Clean Energy.csv', function(dataIn){
    ...
    */
    ...
    svg.append('text')
        ...
        .attr('transform', 'translate(-60,280)rotate(270)')
